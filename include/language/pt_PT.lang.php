...
$app_strings = array (
  ...
  'LBL_EMAIL_WARNING_MISSING_USER_CREDS' => 'Aviso: Falta nome de utilizador e palavra-passe para a conta de e-mail de saída.',
  'LBL_EMAIL_ACCOUNTS_SMTPUSER_REQD' => 'Nome de utilizador SMTP é necessário',
  'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD' => 'Palavra-passe SMTP é necessária',
  ...
  'LBL_SUGAR_COPYRIGHT' => '© 2004-2010 SugarCRM Inc. O Programa é fornecido como está, sem garantia. Licenciado sob AGPLv3.
SugarCRM é uma marca comercial da SugarCRM, Inc. Todas as outras empresas e nomes de produtos podem ser marcas registadas das respectivas empresas.',
  'LBL_SUGAR_COPYRIGHT_SUB' => '© 2004-2010 SugarCRM Inc. Todos os direitos reservados.
SugarCRM é uma marca comercial da SugarCRM, Inc. Todas as outras empresas e nomes de produtos podem ser marcas registadas das respectivas empresas.',
  ...
  'NTC_DELETE_CONFIRMATION_NUM' => 'Tem a certeza que pretende eliminar o',
  'NTC_UPDATE_CONFIRMATION_NUM' => 'Tem a certeza que pretende actualizar',
  'NTC_DELETE_SELECTED_RECORDS' => 'o(s) registo(s) seleccionado(s)?',
...
Clique OK para ver esta Reunião ou clique Cancelar para descartar esta mensagem.',
  ...
  'LBL_SCHEDULE_CALL' => 'Criar Chamada Telefónica',
  ...
  'LBL_SEARCH_HELP_TEXT' => '<p><br /><strong>Controlos Multi-selecção</strong></p>
<ul><li>Clique nos valores para seleccionar um atributo.</li>
<li> Faça Ctrl-click para seleccionar múltiplo. Utilizadores de Mac usam CMD-click.</li>
<li>Para seleccionar todos os valores entre dois atributos, clique no primeiro valor e depois faça shift-click no último valor.</li></ul>
<p><strong>Opções de Pesquisa Avançada & Layout</strong><br>
...
<br>Para personalizar o layout Ver Lista, utilize as caixas Ocultar Colunas e Exibir Colunas para seleccionar os campos a exibir nos resultados da pesquisa. Por exemplo, pode visualizar ou ocultar detalhes tais como o nome de registo, o utilizador ou a equipa atribuída nos resultados da pesquisa. Para adicionar uma coluna a Ver Lista, seleccione o campo da lista Ocultar Colunas e utilize a seta esquerda para movê-lo para a lista Exibir Colunas. Para remover uma coluna de Ver Lista, seleccione-a da lista Exibir Colunas e utilize a seta direita para movê-la para a lista Ocultar Colunas.<br>
<br>Se gravar as configurações do layout, poderá carregá-las em qualquer altura para visualizar os resultados de pesquisa no layout personalizado.<br><br>Para gravar e actualizar uma pesquisa e/ou layout:
<ol>
<li>Insira um nome para os resultados da pesquisa no campo <b>Gravar esta pesquisa como</b> e clique em <b>Gravar</b>. O nome é agora exibido na lista Pesquisas Gravadas adjacente ao botão <b>Limpar</b>.</li>
<li>Para visualizar uma pesquisa gravada, seleccione-a da lista Pesquisas Gravadas. Os resultados da pesquisa são exibidos em Ver Lista.</li>
<li>Para actualizar as propriedades de uma pesquisa gravada, seleccione a pesquisa gravada da lista, insira o novo critério de pesquisa e/ou opções de layout na área Pesquisa Avançada, e clique em <b>Actualizar</b> a seguir a <b>Modificar Pesquisa Actual</b>.</li>
<li>Para eliminar uma pesquisa gravada, seleccione-a na lista Pesquisas Gravadas, clique em <b>Eliminar</b> a seguir a <b>Modificar Pesquisa Actual</b>, e clique depois em <b>OK</b> para confirmar a eliminação.</li>
</ol><p><strong>Dicas</strong><br>
<br>Ao usar o %, como operador wildcard você pode fazer sua pesquisa com um critério mais amplo. Por exemplo, em vez de apenas realizar uma busca de resultados iguais a "Peras", você poderá alterar a sua pesquisa para "%Peras" que seria compatível com todos os resultados que comecem com a palavra Peras, mas pode conter outros termos.</p>',
  ...
  'LBL_MASSUPDATE_DELETE_PRIVATE_TEAMS' => 'Lamentamos, mas não é possível eliminar a(s) equipa(s) privada(s). Abortando',
...
$app_list_strings = array (
  ...
  'lead_source_default_key' => 'Auto Gerada',
