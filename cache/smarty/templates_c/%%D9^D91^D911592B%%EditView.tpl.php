<?php /* Smarty version 2.6.11, created on 2013-12-29 19:12:37
         compiled from cache/modules/ProspectLists/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/ProspectLists/EditView.tpl', 45, false),array('function', 'counter', 'cache/modules/ProspectLists/EditView.tpl', 51, false),array('function', 'sugar_translate', 'cache/modules/ProspectLists/EditView.tpl', 57, false),array('function', 'html_options', 'cache/modules/ProspectLists/EditView.tpl', 91, false),array('function', 'sugar_getimagepath', 'cache/modules/ProspectLists/EditView.tpl', 119, false),array('modifier', 'strip_semicolon', 'cache/modules/ProspectLists/EditView.tpl', 58, false),array('modifier', 'lookup', 'cache/modules/ProspectLists/EditView.tpl', 116, false),array('modifier', 'count', 'cache/modules/ProspectLists/EditView.tpl', 196, false),array('modifier', 'default', 'cache/modules/ProspectLists/EditView.tpl', 338, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=ProspectLists'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'name\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'list_type\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Data de Introdução\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Data de Modificação\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_BY','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'domain_name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOMAIN_NAME','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'entry_count\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ENTRIES','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'marketing_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARKETING_ID','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'marketing_name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARKETING_NAME','module' => 'ProspectLists','for_js' => true), $this); echo '\' );
