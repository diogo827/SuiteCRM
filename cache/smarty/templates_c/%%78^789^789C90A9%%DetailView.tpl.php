<?php /* Smarty version 2.6.11, created on 2013-12-29 19:46:31
         compiled from cache/modules/AOR_Reports/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/AOR_Reports/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/AOR_Reports/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/AOR_Reports/DetailView.tpl', 47, false),array('function', 'sugar_getimagepath', 'cache/modules/AOR_Reports/DetailView.tpl', 151, false),array('modifier', 'strip_semicolon', 'cache/modules/AOR_Reports/DetailView.tpl', 48, false),array('modifier', 'escape', 'cache/modules/AOR_Reports/DetailView.tpl', 132, false),array('modifier', 'url2html', 'cache/modules/AOR_Reports/DetailView.tpl', 132, false),array('modifier', 'nl2br', 'cache/modules/AOR_Reports/DetailView.tpl', 132, false),)), $this); ?>
...
" id="delete_button"><?php endif; ?> </li><li><input class="button" id="export_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_EXPORT']; ?>
" onclick="var _form = document.getElementById('formDetailView');_form.action.value='Export';_form.submit();" name="Export to CSV" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_EXPORT']; ?>
"/></li><li><input class="button" id="download_pdf_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_DOWNLOAD_PDF']; ?>
" onclick="var _form = document.getElementById('formDetailView');_form.action.value='DownloadPDF';_form.submit();" name="Download PDF Report" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_DOWNLOAD_PDF']; ?>
