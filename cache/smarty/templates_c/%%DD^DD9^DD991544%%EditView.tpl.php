<?php /* Smarty version 2.6.11, created on 2013-12-29 18:55:07
         compiled from cache/modules/AOS_Quotes/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/AOS_Quotes/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/AOS_Quotes/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/AOS_Quotes/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/AOS_Quotes/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/AOS_Quotes/EditView.tpl', 152, false),array('function', 'sugar_getimage', 'cache/modules/AOS_Quotes/EditView.tpl', 376, false),array('function', 'sugar_getjspath', 'cache/modules/AOS_Quotes/EditView.tpl', 1241, false),array('function', 'sugar_number_format', 'cache/modules/AOS_Quotes/EditView.tpl', 1461, false),array('modifier', 'default', 'cache/modules/AOS_Quotes/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/AOS_Quotes/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/AOS_Quotes/EditView.tpl', 177, false),array('modifier', 'count', 'cache/modules/AOS_Quotes/EditView.tpl', 257, false),)), $this); ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='number_label' width='12.5%' scope="col">
...
<td valign="top" id='stage_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='expiration_label' width='12.5%' scope="col">
...
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['expiration']['name']; ?>
...
<td valign="top" id='invoice_status_label' width='12.5%' scope="col">
...
<td valign="top" id='term_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='approval_status_label' width='12.5%' scope="col">
...
<?php endif; ?>
<td valign="top" id='approval_issue_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='billing_account_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='billing_contact_label' width='12.5%' scope="col">
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TOTAL_AMT','module' => 'AOS_Quotes'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DISCOUNT_AMOUNT','module' => 'AOS_Quotes'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_TAX_AMT','module' => 'AOS_Quotes'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
addToValidate(\'EditView\', \'number\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_QUOTE_NUMBER','module' => 'AOS_Quotes','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'template_ddown_c[]\', \'multienum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEMPLATE_DDOWN_C','module' => 'AOS_Quotes','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'line_items\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LINE_ITEMS','module' => 'AOS_Quotes','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'shipping_tax\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_TAX','module' => 'AOS_Quotes','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_tax_amt\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_TAX_AMT','module' => 'AOS_Quotes','for_js' => true), $this); echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_opportunity\']={"form":"EditView","method":"query","modules":["Opportunities"],"group":"or","field_list":["name","id"],"populate_list":["opportunity","opportunity_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'EditView_billing_account\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id","billing_address_street","billing_address_city","billing_address_state","billing_address_postalcode","billing_address_country","shipping_address_street","shipping_address_city","shipping_address_state","shipping_address_postalcode","shipping_address_country"],"populate_list":["EditView_billing_account","billing_account_id","billing_address_street","billing_address_city","billing_address_state","billing_address_postalcode","billing_address_country","shipping_address_street","shipping_address_city","shipping_address_state","shipping_address_postalcode","shipping_address_country"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["billing_account_id"],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'EditView_billing_contact\']={"form":"EditView","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["billing_contact","billing_contact_id","billing_contact_id","billing_contact_id"],"required_list":["billing_contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Nada foi Encontrado"};</script>'; ?>
