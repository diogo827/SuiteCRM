<?php /* Smarty version 2.6.11, created on 2013-12-29 18:58:01
         compiled from cache/modules/AOS_PDF_Templates/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 56, false),array('function', 'sugar_getimagepath', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 99, false),array('function', 'html_options', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 132, false),array('function', 'sugar_number_format', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 514, false),array('modifier', 'strip_semicolon', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 57, false),array('modifier', 'lookup', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 157, false),array('modifier', 'count', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 237, false),array('modifier', 'default', 'cache/modules/AOS_PDF_Templates/EditView.tpl', 483, false),)), $this); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SAMPLE','module' => 'AOS_PDF_Templates'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_INSERT_FIELDS','module' => 'AOS_PDF_Templates'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['margin_right']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['margin_right']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['margin_right']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['margin_bottom']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['margin_bottom']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['margin_bottom']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['margin_header']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['margin_header']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['margin_header']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['margin_footer']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['margin_footer']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['margin_footer']['value']);  endif; ?>  
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'active\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACTIVE','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'type\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'sample\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SAMPLE','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'insert_fields\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_INSERT_FIELDS','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'pdfheader\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HEADER','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'pdffooter\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FOOTER','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'margin_left\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARGIN_LEFT','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'margin_right\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARGIN_RIGHT','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'margin_top\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARGIN_TOP','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'margin_bottom\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARGIN_BOTTOM','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'margin_header\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARGIN_HEADER','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'margin_footer\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MARGIN_FOOTER','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'AOS_PDF_Templates','for_js' => true), $this); echo '\', \'assigned_user_id\' );
