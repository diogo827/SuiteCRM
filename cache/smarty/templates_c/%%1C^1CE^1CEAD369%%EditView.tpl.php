<?php /* Smarty version 2.6.11, created on 2013-12-30 00:25:33
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='report_module_label' width='12.5%' scope="col">
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'FIELDS','module' => 'AOR_Reports'), $this);?>

<script>
document.getElementById('detailpanel_2').className += ' expanded';
</script>
</h4>
<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='FIELDS'  class="yui3-skin-sam edit view panelContainer">
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>

<?php ob_start(); ?>
<tr>
<td valign="top" id='field_lines_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FIELD_LINES','module' => 'AOR_Reports'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if ($this->_tpl_vars['panelFieldCount'] == 0): ?>
<script>document.getElementById("FIELDS").style.display='none';</script>
<?php endif; ?>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'CONDITIONS','module' => 'AOR_Reports'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CONDITION_LINES','module' => 'AOR_Reports'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
