...
<script type="text/javascript" src='cache/include/externalAPI.cache.js?v=y3pTHOJffn90OtnnwukWqQ'></script>
...
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Data de Registo\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Data de Alteração\' );
