...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='jjwg_Maps'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='module_type_basic' >{sugar_translate label='LBL_MODULE_TYPE' module='jjwg_Maps'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='module_type_basic' name='module_type_basic[]' options=$fields.module_type_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.module_type_basic.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='jjwg_Maps'}</label>
    	</td>
